...
class RedisStoreTest extends TestCase
{
    ...
    public function test_constructor_accepts_redis_instance(): void
    {
        $store = new RedisStore($this->createRedisConnection(), prefix: 'kv_ctor_'.uniqid().'_');
    ...
    {
        $otherStore = new RedisStore($this->createRedisConnection(), prefix: 'other_'.uniqid().'_');
